...
def main():
    ...
    plot_pressure(t_list, p_well_block, label='BPR (12, 12) Phase-4 Simulator - 23x23 Grid', color='go')
    ...
    plot_rate(t_list, q_list, label='Oil Rate Phase-4 Simulator - 23x23 Grid', color='go')
    ...
    plot_var(t_list, nr_list, y_axis_title='NR iterations per time-step',
    ...
    plot_var(t_list_coarse, cfl_list_coarse, y_axis_title='CFL number', label='CFL number Phase-4 Simulator - 5x5 Grid',
             color='ro')
    plot_var(t_list, cfl_list, y_axis_title='CFL number', label='CFL number Phase-4 Simulator - 23x23 Grid', color='go')
    ...
    plot_pressure(t_list_small_t, p_well_block_small_t, label=r'BPR (12, 12) Phase-4 Simulator - $\Delta t=5 days$',
                  color='ro')
    plot_pressure(t_list, p_well_block, label='BPR (12, 12) Phase-4 Simulator - $\Delta t=10 days$', color='go')
    ...
    plot_rate(t_list, q_list, label='Oil Rate Phase-4 Simulator - $\Delta t=10 days$', color='go')
    ...
    plot_var(t_list, cfl_list, y_axis_title='CFL number', label='CFL number Phase-4 Simulator - $\Delta t=10 days$',
             color='go')
